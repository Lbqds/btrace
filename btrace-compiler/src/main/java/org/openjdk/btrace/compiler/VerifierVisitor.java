...
public class VerifierVisitor extends TreeScanner<Boolean, Void> {
    ...
    public VerifierVisitor(Verifier verifier, Element clzElement) {
        ...
        btraceServiceTm = verifier.getElementUtils().getTypeElement("org.openjdk.btrace.services.spi.BTraceService").asType();
        runtimeServiceTm = verifier.getElementUtils().getTypeElement("org.openjdk.btrace.services.spi.RuntimeService").asType();
        simpleServiceTm = verifier.getElementUtils().getTypeElement("org.openjdk.btrace.services.spi.SimpleService").asType();
        serviceInjectorTm = verifier.getElementUtils().getTypeElement("org.openjdk.btrace.services.api.Service").asType();
    }
