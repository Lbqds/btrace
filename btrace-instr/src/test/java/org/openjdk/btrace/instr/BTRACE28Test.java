    ...
    public void bytecodeValidation() throws Exception {
        ...
        checkTransformation(
                "LDC \"resources.issues.BTRACE28\"\n" +
                        ...
                        "\n" +
                        "// access flags 0xA\n" +
                        "private static $btrace$traces$issues$BTRACE28$tracker(Ljava/lang/String;Ljava/lang/String;)V\n" +
                        ...
                        "GETSTATIC traces/issues/BTRACE28.runtime : Lorg/openjdk/btrace/runtime/BTraceRuntimeImpl;\n" +
