 ...
 * @author KLynch
 */
public final class BTraceRuntimeImpl implements BTraceRuntime.BTraceRuntimeImpl, RuntimeContext {
    ...
    private static final class Accessor implements BTraceRuntime.BTraceRuntimeAccessor {
        @Override
        public BTraceRuntime.BTraceRuntimeImpl getRt() {
            BTraceRuntimeImpl current = getCurrent();
    ...
    public BTraceRuntimeImpl(final String className, ArgsMap args,
    ...
    public int getInstrumentationLevel() {
        BTraceRuntimeImpl cur = getCurrent();
     ...
     */
    public static BTraceRuntimeImpl forClass(Class cl, TimerHandler[] tHandlers, EventHandler[] evHandlers, ErrorHandler[] errHandlers,
                                         ExitHandler[] eHandlers, LowMemoryHandler[] lmHandlers) {
        BTraceRuntimeImpl runtime = runtimes.get(cl.getName());
    ...
    public static void retransform(String runtimeName, Class<?> clazz) {
        try {
            BTraceRuntimeImpl rt = runtimes.get(runtimeName);
    ...
    public long sizeof(Object obj) {
        BTraceRuntimeImpl runtime = getCurrent();
