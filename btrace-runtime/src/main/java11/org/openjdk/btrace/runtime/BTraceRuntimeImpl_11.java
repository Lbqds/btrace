...
public final class BTraceRuntimeImpl_11 extends BTraceRuntimeImplBase {
    public static final class Factory extends BTraceRuntimeImplFactory<BTraceRuntimeImpl_11> {
        ...
        @Override
        public BTraceRuntimeImpl_11 getRuntime(String className, ArgsMap args, CommandListener cmdListener, DebugSupport ds, Instrumentation inst) {
    ...
    public BTraceRuntimeImpl_11(String className, ArgsMap args, CommandListener cmdListener, DebugSupport ds, Instrumentation inst) {
